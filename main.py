...
async def main():
    ...
    # Set budgets and deposit funds
    agent1.set_budget(100.0)
    agent1.wallet.deposit(150.0)

    # Make a payment
    success = await agent1.make_payment(payment_api, 50.0)
    if success:
